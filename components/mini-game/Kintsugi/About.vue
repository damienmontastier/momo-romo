<template>
  <div id="about">
        ...
        <div class="blocks">
          <div class="block block_0" ref="block_0">
            <div class="p_container">
              <p class="skew book">
                The Japanese art of Kintsugi teaches
                <br>that
                <strong>
          ...
          <div class="block block_1" ref="block_1">
            <div class="p_container">
              <p class="skew book">
                We should try to repair things,
                <br>because in doing so we obtain
                <br>
                <strong>more unique and beautiful objects</strong>.
                <br>
                <strong>Broken objects still have history</strong>.
                <br>This is the essence of resilience.
              </p>
            </div>
          </div>
    ...
    <div class="to_be_continued_container" ref="to_be_continued">
      <div class="to_be_continued skew fill-en">to be continued</div>
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    current(val, oldVal) {
      ...
      tl.to(oldBlock || this.$refs.shadow, 0.25, {
        opacity: 0
